...
namespace InTandemRegistrationPortal.Migrations
{
    ...
    [Migration("20190908215112_RepalcedIntWithEnum")]
    partial class RepalcedIntWithEnum
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InTandemRegistrationPortal.Models.InTandemUser", b =>
                {
                    ...
                    b.Property<bool?>("FromNYCares");

                    b.Property<bool?>("HasBeenApproved");

                    b.Property<bool?>("HasBeenTrained");

                    b.Property<bool?>("HasSeat");

                    b.Property<bool?>("HasSingleBike");

                    b.Property<bool?>("HasTandem");
                    ...
                    b.Property<int>("TotalMilesTraveled");
            ...
            modelBuilder.Entity("InTandemRegistrationPortal.Models.RideEvent", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("InTandemRegistrationPortal.Models.RideLeaderAssignment", b =>
                {
                    ...
                    b.ToTable("RideLeaderAssignment");
                });
            ...
            modelBuilder.Entity("InTandemRegistrationPortal.Models.RideLeaderAssignment", b =>
                {
                    ...
                    b.HasOne("InTandemRegistrationPortal.Models.RideEvent", "RideEvent")
